...
## Descarga
Para descargar la herramienta es necesario hacer click en "Code" y luego en "Download as ZIP". Finalmente descomprima el archivo ZIP.
...
correr el código con el comando "python CODE/main.py"
